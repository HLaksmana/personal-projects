...
weekPicklePath = "./week_all.pkl"
playPicklePath = "./play_all.pkl"
modPicklePath = "./modPlays_all.pk1"
...
if(pickle):
    ...
    week =  pd.concat([week2, week3, week4, week5, week6, week7, week8, week9, week10, week11, week12, week13, week14, week15, week16, week17], ignore_index=True)
...
with open('model_Layer_Exp2.csv','w') as f1:
    ...
    writer.writerow([LSTM_layers, Dense_layers, trainMSE, testMSE])
    results.append([LSTM_layers, Dense_layers, trainMSE, testMSE])
np.savetxt("modellayerexp.csv", results, delimiter=",")
print(results)
